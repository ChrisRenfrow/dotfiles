...
(setq user-full-name "Chris Renfrow"
      user-mail-address "dev@chrisrenfrow.me")

(map! :leader
      :prefix ("r" . "Org roam")
      "ni" #'org-roam-node-insert
      "nc" #'org-roam-node-create
...
(use-package! org-roam
  ...
  (unless (file-exists-p "~/org-roam/dailies")
    (make-directory "~/org-roam/dailies"))
